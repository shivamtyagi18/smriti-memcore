...
\textbf{NEXUS Dual-Process} & \textbf{80.0\%} & \textbf{0.98s} \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig5_longmemeval_accuracy.png}}
\caption{LongMemEval exact-match accuracy comparison.}
\label{fig:longmem_accuracy}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig6_longmemeval_latency.png}}
